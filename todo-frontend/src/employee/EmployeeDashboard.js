    ...
    <aside className="w-64 h-screen bg-white flex flex-col sticky top-0 border-r border-slate-200">
      ...
      <div className="p-4 border-b border-slate-200">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-lg font-bold text-slate-800">Employee Panel</h1>
        </div>
      </div>

      {/* 2. Main Navigation Links */}
      <nav className="flex-1 p-4 flex flex-col space-y-1">
        <NavLink to="/employee" className={getLinkClass} end> {/* `end` prop for exact match */}
          <Home size={20} />
          <span>Home</span>
        </NavLink>

        <NavLink to="/employee/empAssignedTasks" className={getLinkClass}>
          <Cpu size={20} /> 
        ...
        <NavLink to="/employee/task-recommender" className={getLinkClass}>
          <BarChart2 size={20} />
          <span>Recommender</span>
        </NavLink>
        <NavLink to="/employee/task-summary" className={getLinkClass}>
          <BarChart2 size={20} />
          <span>Summary</span>
        </NavLink>
         <NavLink to="/employee/notifications" className={getLinkClass}>
          <Bell size={20} />
